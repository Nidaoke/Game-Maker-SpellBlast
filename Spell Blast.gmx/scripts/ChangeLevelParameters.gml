...
if rm != "rm_tutorial"
{
    ...
    if global.world=0
    {
       global.word_length=4
       global.force_letter_spawMAX=4 global.spawn_frequency=3
    }
    if global.world=1
    {
       global.word_length=5
       global.force_letter_spawMAX=5 global.spawn_frequency=4
    }
    if global.world=2
    {
       global.word_length=6
       global.force_letter_spawMAX=6 global.spawn_frequency=5
    }
    if global.world=3
    {
       global.word_length=7
